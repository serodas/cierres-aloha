 ...
 */
class Motivo extends \AppBundle\Entity\Motivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Motivo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Motivo' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Motivo' . "\0" . 'descripcion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Motivo $proxy) {

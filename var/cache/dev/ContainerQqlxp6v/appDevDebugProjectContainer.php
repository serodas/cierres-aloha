...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'security.logout_listener.login' => 'getSecurity_LogoutListener_LoginService.php',
    ...
    protected function getFosRest_Versioning_ListenerService()
    {
        ...
        return $this->services['fos_rest.versioning.listener'] = new \FOS\RestBundle\EventListener\VersionListener(${($_ = isset($this->services['FOS\RestBundle\View\ViewHandlerInterface']) ? $this->services['FOS\RestBundle\View\ViewHandlerInterface'] : $this->getViewHandlerInterfaceService()) && false ?: '_'}, $a, NULL);
    }

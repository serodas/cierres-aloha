...
$b->setMetadataCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.mysql_metadata_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.mysql_metadata_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_MysqlMetadataCacheService.php')) && false ?: '_'});
$b->setQueryCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.mysql_query_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.mysql_query_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_MysqlQueryCacheService.php')) && false ?: '_'});
$b->setResultCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.mysql_result_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.mysql_result_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_MysqlResultCacheService.php')) && false ?: '_'});
...
$this->services['doctrine.orm.mysql_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.mysql_connection']) ? $this->services['doctrine.dbal.mysql_connection'] : $this->load('getDoctrine_Dbal_MysqlConnectionService.php')) && false ?: '_'}, $b);

${($_ = isset($this->services['doctrine.orm.mysql_manager_configurator']) ? $this->services['doctrine.orm.mysql_manager_configurator'] : $this->services['doctrine.orm.mysql_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array())) && false ?: '_'}->configure($instance);

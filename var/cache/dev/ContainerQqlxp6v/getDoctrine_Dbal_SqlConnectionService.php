...
$a->addLogger(${($_ = isset($this->services['doctrine.dbal.logger.profiling.sql']) ? $this->services['doctrine.dbal.logger.profiling.sql'] : $this->services['doctrine.dbal.logger.profiling.sql'] = new \Doctrine\DBAL\Logging\DebugStack()) && false ?: '_'});
...
return $this->services['doctrine.dbal.sql_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => '192.168.6.230', 'port' => 1433, 'dbname' => NULL, 'user' => 'interfase_user', 'password' => '1nt3rf4s3us3r', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
